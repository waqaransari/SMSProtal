...
class examSchedule extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('teacher/exam_schedule/examList', $data);
            ...
            $examSchedule = $this->examschedule_model->getExamByClassandSection($data['class_id'], $data['section_id'],$data['part_id']);
    ...
    function view($id) {
        ...
        $data['exam'] = $exam;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/exam_schedule/examShow', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function delete($id) {
        ...
        redirect('teacher/exam_schedule/index');
    }
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/exam_schedule/examCreate', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            ...
            $examSchedule = $this->teachersubject_model->getDetailbyClsandSection($class_id, $section_id, $exam_id, $part_id);
            $data['examSchedule'] = $examSchedule;
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/exam_schedule/examEdit', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
            $data = array(
                'id' => $id,
