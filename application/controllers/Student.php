...
class Student extends Admin_Controller {
    ...
    function edit($id) {
        ...
        $category = $this->category_model->get();
        $data['categorylist'] = $category;
        //$data['parts'] = $this->db->get_where("batch_class")->result_array();
        $data['parts'] = $this->getBatchClass();
        $this->form_validation->set_rules('firstname', 'First Name', 'trim|required|xss_clean');
        $this->form_validation->set_rules('lastname', 'Last Name', 'trim|required|xss_clean');
        $this->form_validation->set_rules('dob', 'Date of Birth', 'trim|required|xss_clean');
    ...
    function getByClassAndSection() {
        ...
        $part = ($this->input->get('part_id') ? $this->input->get('part_id') : null) ;
        $section = $this->input->get('section_id');
        $resultlist = $this->student_model->searchByClassSection($class, $section,$part);
