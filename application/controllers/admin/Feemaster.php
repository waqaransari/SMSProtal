...
class Feemaster extends Admin_Controller {
    ...
    function assign($id) {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            $resultlist = $this->studentfeemaster_model->searchAssignFeeByClassSection($data['class_id'], $data['section_id'], $id, $data['category_id'], $data['gender'], $data['rte_status'],$data['part_id']);
