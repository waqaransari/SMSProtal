                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                    ...
                                    <tbody>
                                        ...
                                        $alot_fee_discount = 0;
                                        foreach($student_due_fee as $due_fee){
                                            if(!empty($due_fee)){
                                        foreach ($due_fee as $key => $fee) {
                                        ...
                                        if (!empty($student_discount_fee)) {
                                            foreach($student_discount_fee as $discount){
                                                if(!empty($discount)){ 
...
<script type="text/javascript">
    ...
    function getStudentsByClassAndSection() {
        ...
        $.ajax({
            ...
            data: {'class_id': class_id, 'part_id': part_id, 'section_id': section_id},
            dataType: "json",
            success: function (data) {
                $.each(data, function (i, obj)
                {
