    ...
    <section class="content">
        <div class="row">           
            ...
            if (isset($resultlist)) {
                ...
                <input type="hidden" class="part_id" value="<?php echo $part_id; ?>" >
                    ...
                    <div class="box-body">
                        <form action="#"  method="post" accept-charset="utf-8" class="promote_form">
                            <div class="row">
                                ...
                                <?php echo getBatchClass("col-md-4","promote");?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?></label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#pramoteStudentModal').on('click', '.pramote_student', function (e) {
            ...
            var part_promote_id = $(".part_promote_id").val();
            var class_post = $(".class_post").val();
            var section_post = $(".section_post").val();
            var part_post = $(".part_id").val();
            $.ajax({
                type: "POST",

                url: '<?php echo site_url("admin/stdtransfer/promote") ?>',
                data: datastring + '&class_post=' + class_post + '&section_post=' + section_post+'&part_post'+part_post,
                beforeSend: function () {
