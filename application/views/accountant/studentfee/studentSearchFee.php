        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('accountant/studentfee/feesearch') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">FeeGroup</label>
                                        ...
                                        foreach ($student_due_fee as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text text-right"><?php
                                                    ...
                                                    ?></td>
                                                <td class="text text-right"><a href="<?php echo base_url(); ?>accountant/studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-info btn-xs">
    ...
    $(document).ready(function () {
        function getSectionByClass(feecategory_id, feetype_id) {
            if (feecategory_id != "" && feetype_id != "") {
                ...
                $.ajax({
                    type: "GET",
                    url: base_url + "accountant/feemaster/getByFeecategory",
