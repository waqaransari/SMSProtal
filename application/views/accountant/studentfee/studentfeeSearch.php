                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('accountant/studentfee/search') ?>" method="post" class="">
                                        ...
                                        <?php echo getBatchClass("col-sm-4",null,$part_id);?>   
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    <a  href="<?php echo base_url(); ?>accountant/studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
