            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="<?php echo site_url('accountant/studentfee/searchpayment') ?>" method="post" class="form-inline">
                                ...
                                <tbody>
                                    ...
                                    if (empty($feeList)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $feeList->class . " (" . $feeList->part . ")". " (" . $feeList->section . ")"; ?>
                                            </td> 
                                            <td>
                                            ...
                                            <td class="text text-right">
                                                <a href="<?php echo base_url() ?>accountant/studentfee/addfee/<?php echo $feeList->student_id ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-original-title="<?php echo $this->lang->line('view'); ?>">
