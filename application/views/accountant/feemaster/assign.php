    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="">
                            ...
                            <form role="form" action="<?php echo site_url('accountant/feemaster/assign/' . $id) ?>" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo getBatchClass("col-sm-2",null,$part_id);?>   
                                    <div class="col-sm-2">
                ...
                <form method="post" action="<?php echo site_url('accountant/studentfee/addfeegroup') ?>" id="assign_form">
