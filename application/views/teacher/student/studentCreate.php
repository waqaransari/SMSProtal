            ...
            <div class="col-md-12">             
                <div class="box box-primary">
                    ...
                    <div class="pull-right box-tools" style="position: absolute;right: 14px;top: 13px;">                           
                        <a href="<?php echo site_url('teacher/student/import') ?>">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_student'); ?></button>
                        </a>
                    </div>

                    <form id="form1" action="<?php echo site_url('teacher/student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero"> 
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php echo getBatchClass("col-sm-3",null,"");?>
                                        <div class="col-md-3">
                                            <div class="form-group">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label"><?php echo $this->lang->line('class'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line('section'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line('student_name'); ?>
                            </label>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add_sibling', function () {
        ...
        if (student_id.length > 0) {
            $.ajax({
                type: "GET",
                url: base_url + "teacher/student/getStudentRecordByID",
