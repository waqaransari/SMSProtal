                                                ...
                                                <div id="carousel-2" class="carousel slide slide-carousel" data-ride="carousel">
                                                    <div class="carousel-inner">
                                                        <div class="item active">
                                                            <a href="<?php echo base_url(); ?>teacher/student/view/<?php echo $student['id'] ?>"> <img class="img-responsive img-thumbnail" alt="Cinque Terre" style="width:150px;height:150px;" src="<?php echo base_url() . $student['image'] ?>" alt="Image"></a>
                                                        </div>
                                                    </div>
                                                </div>
