...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-9" style="<?php echo ($content_hide == 1 ? 'display:none;':'');?>">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="documents">
                            <div class="timeline-header no-border">
                                <button type="button"  data-student-session-id="<?php echo $student['student_session_id'] ?>" class="btn btn-xs btn-primary pull-right myTransportFeeBtn mb10"> <i class="fa fa-upload"></i>  Upload Documents</button>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="mml15" style="margin-top:5px; border:0; outline:none;">
                                                    <input id="first_doc_id" name="first_doc" placeholder="" type="file" style="margin-top:8px; border:0; outline:none;" class="filestyle form-control"  value="<?php echo set_value('first_doc'); ?>" />
