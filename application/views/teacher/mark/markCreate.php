        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('teacher/mark/create') ?>"  method="post" accept-charset="utf-8" id="schedule-form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <?php echo getBatchClass("col-md-4",null,$part_id);?>
                                <div class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($examSchedule)) {
                                ?>
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('teacher/mark/create') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="checkbox">
                                                                        ...
                                                                        <label><input type="checkbox" name="student_absent<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="ABS" <?php if ($exam_schedule['attendence'] == "ABS") echo "checked"; ?>>Abs</label>
                                                                    </div>
                                                                    <input type="text" name="student_number<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" class="form-control input-sm" id="subject_<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="<?php echo $exam_schedule['get_marks'] ?>" placeholder="Enter Marks">
                                                                </div>
