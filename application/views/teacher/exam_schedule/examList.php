                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>teacher/examschedule/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></a>
                        </div>
                    </div>
                    <form action="<?php echo site_url('teacher/examschedule/index') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
