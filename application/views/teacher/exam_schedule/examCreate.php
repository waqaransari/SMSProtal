        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('teacher/examschedule/create') ?>"  method="post" accept-charset="utf-8" id="schedule-form">
                        <div class="box-body">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($examSchedule)) {
                                ?>
                                <form role="form" id="" class="addschedule-form" method="post" action="<?php echo site_url('teacher/examschedule/create') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
...
<script src="<?php echo base_url() ?>backend/plugins/timepicker/jquery.validate.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url() ?>backend/plugins/timepicker/bootstrap-datepicker.js"></script>
<script>
    $(function () {
